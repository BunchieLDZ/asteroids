class Game {
    ...
    restart() {
        ...
        console.log("Canva: ", this.game_canvas.bind(this));
        console.log("Szerokosc : ", this.game_canvas.width.bind(this));
        this.restart_game.bind(this);
    }
    restart_game() {
        console.log("Restartuje gre!");

        //this.uiobjects.push(vjoy);
        ...
        for (var j = 0; j < imgdata1.data.length; j+= resolution) {
            for (var i = 3; i < imgdata1.data.length; i += 4) // sprawdzanie kanalu alpha obiektow
            {
               ...
               // console.log("Wielkosc tablicy 2:", imgdata2.data.length);
                ...
                else if(imgdata1.data[i] != 0 && imgdata2.data[i] != 0) { // jesli nie jest to mamy do czynienia z kolizja
